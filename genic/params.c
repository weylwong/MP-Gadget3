...
create_parameters()
{
    ...
    param_declare_int(ps, "CompensatedShift", OPTIONAL, 1, "Compensate for the position shifting of baryons relative to CDM with a rotation of the Fourier phase.");
...
void read_parameterfile(char *fname)
{
    ...
    All2.CompensatedShift = param_get_int(ps, "CompensatedShift");
